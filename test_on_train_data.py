def main(train):
    ...
    data.aavec = data.aavec.apply(convert_back2arrays)
    data.bavec = data.bavec.apply(convert_back2arrays)
    data.cavec = data.cavec.apply(convert_back2arrays)
    data.davec = data.davec.apply(convert_back2arrays)
    ...
    if train == True:
        ...
        print(sum('C' ==data['correctAnswer'])/len(data))
    else:
